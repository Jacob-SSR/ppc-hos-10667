...
import type {
    MiniThanMapData,
    MiniThanMapPoint,
} from "@/app/api/minithan-map/route";
                        ...
                        >
                            {colorMode && (
                                <span
                                    ...
                                    style={{ background: active ? "#fff" : colorHex(opt) }}
                                />
                            )}
                            {opt || "ไม่ระบุ"}
                        </button>
...
export default function MiniThanMapView() {
    ...
    const focusPoint = (p: MiniThanMapPoint) => {
        setSelectedId(p.id);
        const map = mapRef.current;
                ...
                <div className="flex items-center gap-2.5">
                    ...
                    <div>
                        <h1 className="text-base font-bold text-gray-800 leading-tight">
                            แผนที่บ้านผู้ป่วยมินิธัญญารักษ์
                        </h1>
