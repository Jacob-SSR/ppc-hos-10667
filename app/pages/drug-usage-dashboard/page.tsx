...
const KINDS: {
    ...
    hasStrength?: boolean;
        ...
        {
            key: "supply", label: "วัสดุสิ้นเปลืองจริง", short: "วัสดุ", icon: Bandage,
            title: "สรุปการใช้วัสดุสิ้นเปลืองจริงตามมูลค่า",
            desc: "เวชภัณฑ์ที่มิใช่ยา หมวด 05 เฉพาะรายการที่เป็นของจับต้องได้จริง (HOSxP)",
        ...
        },
        {
            ...
            desc: "รายการในทะเบียนเวชภัณฑ์มิใช่ยาที่เป็นค่าบริการ/หัตถการ ไม่ใช่ของจับต้องได้ (HOSxP)",
