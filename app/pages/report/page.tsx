                ...
                <AnimatePresence mode="wait">
                    ...
                    {loading && (
                        <motion.div
                            ...
                            exit="exit"
                        >
                            <div className="mb-4 h-5 w-48 rounded-md bg-gray-200 animate-pulse" />
                                        ...
                                        <tr>
                                            {Object.keys(paginatedData[0]).map((key, i) => (
                                                <motion.th
                                                    ...
                                                    className="sticky top-0 bg-green-800 text-white text-sm font-semibold px-4 py-3 text-left cursor-pointer whitespace-nowrap border-r border-green-700 select-none"
                                                    initial={{ opacity: 0 }}
                                                    animate={{ opacity: 1 }}
