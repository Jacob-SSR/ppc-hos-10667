...
import { RefreshCw, TrendingUp, AlertTriangle, BadgeCheck } from "lucide-react";
...
export default function BillingDashboardPage() {
  ...
  const fetchData = useCallback(async (refresh = false) => {
    ...
    setError(null);
    try {
      const url = refresh ? "/api/billing-dashboard?refresh=1" : "/api/billing-dashboard";
